...
switch method
    ...
    case 'trapezoid'
        ...
        % problem.options(2).method = 'trapezoid'; % ---- Amplify 6/5/26
        % problem.options(2).trapezoid.nGrid = 40; % ---- Amplify 6/5/26
        % problem.options(3).method = 'trapezoid'; % ---- Amplify 6/5/26
        % problem.options(3).trapezoid.nGrid = 60; % ---- Amplify 6/5/26
...
disp 'demo: acrobot';  % ---------- Amplify 6/5/26