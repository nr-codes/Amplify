...
method = 'hermiteSimpsonGrad';   % Suggested method  % ----- Amplify 6/5/26
% method = 'chebyshev';  % --------------------------------- Amplify 6/5/26  
...
disp 'demo: five-link biped';  % --------------------- Amplify 6/5/26

% Amplify CSV Additions ------------------------------------ Amplify 6/5/26
% xdot = dynamics(soln.grid.time,soln.grid.state,soln.grid.control,param);
% writematrix(soln.grid.time, 'fminconsoln.csv', 'writemode', 'overwrite')
% writematrix(soln.grid.state, 'fminconsoln.csv', 'writemode', 'append')
% writematrix(soln.grid.control, 'fminconsoln.csv', 'writemode', 'append')
% writematrix(xdot(6:end, :), 'fminconsoln.csv', 'writemode', 'append')